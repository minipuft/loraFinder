...
const ImageViewer = ({ images, isLoading, error, selectedFolder, isGrouped, zoom, }) => {
    ...
    _jsx("div", { className: `${styles.imageViewer} flex flex-col h-full`, children: _jsx("div", { className: `${styles.contentContainer} flex-1`, children: error ? (
            ...
            _jsxs("div", { className: "text-center text-accent-red", children: [_jsxs("p", { children: ["Error: ", error instanceof Error ? error.message : String(error)] }), _jsx("p", { children: "Please try again later or contact support if the problem persists." })] })) : isLoading ? (
