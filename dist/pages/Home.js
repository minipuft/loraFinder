...
const Home = () => {
    ...
    return (_jsx(Layout, { folders: folders, selectedFolder: selectedFolder, onFolderChange: handleFolderChange, currentDirectory: selectedFolder, onSearch: handleSearch, zoom: zoom, onZoomChange: handleZoomChange, isGrouped: isGrouped, onGroupToggle: handleGroupToggle, children: _jsx(MainContent, { images: images, zoom: zoom, searchQuery: searchQuery, isLoading: isLoading, error: error, selectedFolder: selectedFolder, onUploadComplete: handleUploadComplete, isGrouped: isGrouped }) }));
};
export default Home;
